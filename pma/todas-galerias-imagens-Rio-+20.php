<?php /** Template Name: Todas as Galerias de Imagens da Rio +20 */ get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
        ...
        <h2>Galeria de Imagens - Rio +20</h2>
        
        <?php query_posts('category_name=Rio +20'); while (have_posts()) : the_post(); ?>        
