<?php /** Template Name: informativos 2014*/ get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">  
                <h2>Informativos DMA 2014</h2>

		<ul class="lista"> 
        <?php $paged = (get_query_var('paged')); get_query_var('paged') ; ?> 
        <?php query_posts('category_name=Informativos DMA 2014' 
...
<h5><?php if(function_exists('wp_pagenavi')) { wp_pagenavi(); } ?></h5>
		...
		<h4>
		<a href="http://www.meioambiente.ufrn.br/?page_id=16367" style="margin-left:350px;"> » 2013</a>
		<a href="http://www.meioambiente.ufrn.br/?page_id=8322"> &#187; 2012</a>
