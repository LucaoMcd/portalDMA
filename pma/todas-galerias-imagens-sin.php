<?php /** Template Name: Todas as Galerias de Imagens SIN */ get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
        ...
        <h2>Galeria de Imagens - A&ccedil;&otilde;es da Superintend&ecirc;ncia de Infraestrutura</h2>
        
        <?php query_posts('category_name=Album SIN'); while (have_posts()) : the_post(); ?>        
