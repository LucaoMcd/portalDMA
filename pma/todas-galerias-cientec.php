<?php /** Template Name: Todas as Galerias de Imagens da CIENTEC */ get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
        ...
        <h2>Galeria de Imagens - CIENTEC</h2>
        
        <?php query_posts('category_name=Album CIENTEC'); while (have_posts()) : the_post(); ?>        
