<?php /** Template Name: Mural*/ get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">  
        ...
        <?php query_posts('category_name=Destaques - MURAL'); for ( $retranca = 1; $retranca <=3; $retranca++ ) : the_post(); ?>
        ...
        <ul class="lista">
        <?php query_posts('category_name=Natal - MURAL'); for ( $retranca = 1; $retranca <=6; $retranca++ ) : the_post(); ?>            
        ...
        <ul class="lista">
        <?php query_posts('category_name=Brasil - MURAL'); for ( $retranca = 1; $retranca <=6; $retranca++ ) : the_post(); ?>            
                <li><a href="<?php the_permalink() ?>"><?php the_excerpt(); ?></a></li>            
        <?php endfor;?>
        </ul>
        ...
        <!----------------------- CINE VERDE --------------------------------------------------------------------------->        
            <div class="box1">
            	<h2>Cine Verde</h2>
                <?php query_posts('category_name=Cine - MURAL'); for ( $retranca = 1; $retranca <=1; $retranca++ ) : the_post(); ?>
                <?php the_content(); ?>
                <?php endfor;?>
            </div>        
        <!----------------------- FIM DO CINE VERDE ------------------------------------------------------------------->       
        ...
        <!----------------------- VÍDEOS --------------------------------------------------------------------------->        
            <div class="box2">
            	<h2>Vídeos</h2>
                <?php query_posts('category_name=Videos - MURAL'); for ( $retranca = 1; $retranca <=1; $retranca++ ) : the_post(); ?>
                <?php the_content(); ?>
                <?php endfor;?>
        ...
        <!----------------------- PERSONALIDADES --------------------------------------------------------------------------->        
        	<ul class="box1 galeria">
                ...
                <?php query_posts('category_name=Personalidades - MURAL'); for ( $retranca = 1; $retranca <=4; $retranca++ ) : the_post(); ?>
        ...
        <!----------------------- GALERIA DE IMAGENS --------------------------------------------------------------------------->        
        	<ul class="box2 galeria">
                ...
                <?php query_posts('category_name=Galeria de imagens - MURAL'); for ( $retranca = 1; $retranca <=4; $retranca++ ) : the_post(); ?>
                <li><a href="<?php the_permalink() ?>"><?php the_post_thumbnail(); ?></a></li>
                <?php endfor;?>
        ...
        <!----------------------- CURIOSIDADES --------------------------------------------------------------------------->        
        	<div class="box1" id="curiosidades">
            	<h2>Curiosidades</h2>
                <?php query_posts('category_name=Curiosidades - MURAL'); for ( $retranca = 1; $retranca <=1; $retranca++ ) : the_post(); ?>
                <a href="<?php the_permalink() ?>"><?php the_post_thumbnail(); ?></a>
                <?php endfor;?>
        ...
        <!----------------------- CHARGES --------------------------------------------------------------------------->        
        	<div class="box2" id="charges">
            	<h2>Charges</h2>
                <?php query_posts('category_name=Charges - MURAL'); for ( $retranca = 1; $retranca <=1; $retranca++ ) : the_post(); ?>
                <?php the_content(); ?>
                <?php endfor;?>
            </div>        
        <!----------------------- FIM DE CHARGES -------------------------------------------------------------------> 
