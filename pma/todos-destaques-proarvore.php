<?php
/** Template Name: Todas as Notícias Destaques - PROARVORE*/
get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
		...
		<!----------------------- NOTICIAS DESTAQUE -------------------------------------------------------------->
        <h2>DESTAQUES DO PROARVORE</h2>
        <ul class="lista"> 
        <?php $paged = (get_query_var('paged')); get_query_var('paged') ; ?> 
        <?php query_posts('category_name=Destaques - PROARVORE' .'&paged=' .$paged); while (have_posts()) : the_post(); ?>                      	
