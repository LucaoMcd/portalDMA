<?php /** Template Name: Todas as Galerias de Imagens de Bem Vindo a UFRN */ get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
        ...
        <h2>Galeria de Imagens - Bem vindo à UFRN</h2>
        
        <?php query_posts('category_name=Album Bem Vindo a UFRN'); while (have_posts()) : the_post(); ?>        
