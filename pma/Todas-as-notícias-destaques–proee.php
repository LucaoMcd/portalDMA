<?php
/** Template Name: Todas as Notícias Destaques - PROEE*/
get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
		...
		<!----------------------- NOTICIAS DESTAQUE -------------------------------------------------------------->
        <h2>DESTAQUES DO PROEE</h2>
        <ul class="lista"> 
        <?php $paged = (get_query_var('paged')); get_query_var('paged') ; ?> 
        <?php query_posts('category_name=Destaques - PROEE' .'&paged=' .$paged); while (have_posts()) : the_post(); ?>                      	
