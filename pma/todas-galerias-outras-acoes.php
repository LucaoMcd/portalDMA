<?php /** Template Name: Todas as Galerias de Imagens Outras Ações */ get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
        ...
        <h2>Galeria de Imagens - Outras Ações</h2>

        <?php query_posts('category_name=Galeria de imagens - outras acoes'); while (have_posts()) : the_post(); ?>
