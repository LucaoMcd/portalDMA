<?php /** Template Name: Todas as Galerias de Imagens Coleta Seletiva Solidária */ include "header.php"; ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
        ...
        <h2>Galeria de Imagens - PROGIRES</h2>

        <?php query_posts('category_name=Album CSS'); while (have_posts()) : the_post(); ?>
