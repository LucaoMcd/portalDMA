...
<div id="banners-grandes">  
    <?php query_posts('category_name=Banners grandes - MURAL');
...
<!--<h3>Dicas de blogs</h3> 
    ...
    <?php query_posts('category_name=Dicas de blogs - MURAL');
	for ( $retranca = 1; $retranca <=1; $retranca++ ) : the_post(); 
   		 the_content(); 
   	endfor;?>
</ul>--> 
...
<h3>Dicas de páginas</h3> 
    <ul class="banners-pequenos">  
    <?php query_posts('category_name=Dicas de paginas - MURAL');
	for ( $retranca = 1; $retranca <=1; $retranca++ ) : the_post(); 
   		 the_content(); 
   	endfor;?>
</ul> 
...
<div id="banners-grandes">  
    <?php query_posts('category_name=Banners grandes baixo - MURAL');
	for ( $retranca = 1; $retranca <=1; $retranca++ ) : the_post(); 
   		 the_content(); 
   	endfor;?>
</div> 