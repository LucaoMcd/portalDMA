<?php /** Template Name: Todas as Galerias de Imagens Sembragires */ get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
        ...
        <h2>Galeria de Imagens - SEMBRAGIRES</h2>
        
        <?php query_posts('category_name=Album SEMBRAGIRES'); while (have_posts()) : the_post(); ?>        
