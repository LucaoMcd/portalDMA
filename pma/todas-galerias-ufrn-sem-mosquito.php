<?php /** Template Name: Todas as Galerias de Imagens UFRN sem mosquito */ get_header(); ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
        ...
        <h2>Galeria de Imagens - UFRN sem mosquito</h2>
        
        <?php query_posts('category_name=Album UFRN sem mosquito'); while (have_posts()) : the_post(); ?>        
