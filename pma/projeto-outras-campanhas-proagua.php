<?php /** Template Name: Projeto Outras Campanhas do PROAGUA*/ include "header-progires.php"; ?>
...
<div id="content">
	...
	<div id="lado-esquerdo">
       ...
       <?php $paged = (get_query_var('paged')); get_query_var('paged') ; ?>
        <?php query_posts('category_name=Outras Campanhas ProAGUA' .'&paged=' .$paged); while (have_posts()) : the_post(); ?>
