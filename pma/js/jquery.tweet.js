(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      username: ["PedroHenriGomes"],                // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          var tweets = $.map(data.results || data, function(item){
            ...
            var time = '<span class="tweet_time"><a href="'+tweet_url+'" title="Ver tweet no Twitter">'+tweet_relative_time+'</a></span>';
